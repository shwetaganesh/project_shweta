...
public class CreateNewConfigurationSearchablePage extends TestBase
{
Random rand = new Random();
	...
	@FindBy(xpath = "//ul[@role='menu']//li//a[contains(text(),'Run Now')]")
	...
	private WebElement runtimeAnalyticsButton;
	
	@FindBy(xpath = "//h4[contains(text(),'Add Attribute')]")
	private WebElement addAttributeText;
	
	
	@FindBy(xpath = "(//span[contains(text(),'Select')])[3]")
	private WebElement attributeTypeDropDownButton;
	
	@FindBy(xpath = "//h4[contains(text(),'Edit Attribute')]")
	private WebElement editAttributeLabel;
	
	@FindBy(xpath = "//input[@id='attributeValue_0']")
	private WebElement valuesBox;
	
	@FindBy(xpath = "//a[contains(text(),'Run Control')]")
	private WebElement runCtrlBtn;
	
	@FindBy(xpath = "//h3[contains(text(),'Analytics History')]")
	private WebElement analyticsHistoryLabel;
	
	@FindBy(xpath = "//a[contains(text(),'Refresh Data')]")
	private WebElement refreshDatalBtn;
	

	
	
//	@FindBy(xpath = "(//div[@class='actions']//a//i)[1]")
//	private WebElement toggleButton;
	
//	@FindBy(xpath = "(//div[@class='actions']//ul//li)[1]")
//	private WebElement exportButton;
	
//	@FindBy(xpath = "(//div[@class='actions']//ul//li[3])[1]")
//	private WebElement excelButton;
	
	

	public CreateNewConfigurationSearchablePage(WebDriver ldriver)
	{
		driver = ldriver;
	...
	public void clickOnRunTimeAnalyticsButton()
	{
		TestBase.scrollDownToElement(driver, runtimeAnalyticsButton);
		runtimeAnalyticsButton.click();
	}
	...
	{
		wait.until(ExpectedConditions.visibilityOf(addAttributeText));
		attributeTypeDropDownButton.click();
	...
	public void addOwnerAndUpdate(String owner)
	{
		...
		// TestBase.javaScriptClickbyElement(driver, ownerSubmitButton);
	...
	{
		wait.until(ExpectedConditions.visibilityOf(editAttributeLabel));
		valuesBox.clear();
		valuesBox.sendKeys("mos30v");
		runCtrlBtn.click();
	}

	public void refreshData()
	{
		wait.until(ExpectedConditions.visibilityOf(analyticsHistoryLabel));
		refreshDatalBtn.click();
		valuesBox.clear();
		valuesBox.sendKeys("hofep0");
		runCtrlBtn.click();
	}
