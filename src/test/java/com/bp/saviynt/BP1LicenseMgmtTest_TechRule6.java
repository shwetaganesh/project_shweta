...
public class BP1LicenseMgmtTest_TechRule6  extends TestBase{
	...
	public void checkCreationOfAddAccessTasks() throws InterruptedException, IOException
	{
		...
		logger =extent.createTest("Bp1 license mgmt test for :AAD|NonBP|Remote|ExceptChinaTurkeyIndonesia");
		...
		if(status)
		{
			...
			adminPage.addCustomProperties("SLP","IN","Non-BP","True","RemoteUserMailbox");
	...
	public void checkCreationOfRemoveAccessTasks() throws InterruptedException, IOException
	{
		...
		logger =extent.createTest("Bp1 license mgmt test for :AAD|NonBP|Remote|ExceptChinaTurkeyIndonesia... removal test");
		...
		if(status)
		{
			TestBase.scrollUp(driver);
			adminPage.clickOnOtherAttributesTab();
			adminPage.removeCustomProperties("IN","Non-BP","True","RemoteUserMailbox");
			adminPage.clickOnUpdate();
